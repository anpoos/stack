...
create table employee (id integer(10) auto_increment primary key, first_name varchar(30), last_name varchar(20), emp_no varchar(20) not null, user_name varchar(30), password varchar(100), email varchar(30) not null, is_active varchar(20) default 1);
